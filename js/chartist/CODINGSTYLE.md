...
`<script src="meteo_today.js"></script>` will block the whole DOM parsing until the script has fully loaded and executed. This
...
<html>
  ...
  <body>
    ...
    <script src="meteo_today.js" async></script>
  </body>
</html>
```
...
<body>
  ...
  <script async src="meteo_today.js"></script>
</body>
</html>
```
...
<script src="meteo_today.js" type="text/javascript"></script>
```

**Recommended**
```
<link rel="stylesheet" href="main.css">
<script src="meteo_today.js"></script>
```
